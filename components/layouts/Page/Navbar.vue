...
<template>
  <header
    class="flex fixed backdrop-filter backdrop-blur-md top-0 z-40 w-full flex-none transition-colors duration-300 lg:z-50 border-b border-gray-950/10 dark:border-gray-50/[0.2] bg-white/[0.5] dark:bg-gray-950/[0.5] pb-3 pt-3"
  >
    <!-- content -->
    <div
      ...
      <div>
        <slot name="title">
          <NuxtLink to="/" class="font-bold text-lg">
            <Img
              src="/jap_logo.jpg"
              class="font-black text-xl font-mono mr-2 inline-block rounded-full logo"
            />
          </NuxtLink>
        </slot>
      </div>
