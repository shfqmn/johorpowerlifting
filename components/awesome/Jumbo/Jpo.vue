        ...
        <div class="row">
          <div class="wrapper2">
            ...
            <div style="z-index: 20" ref="poster" class="pt-2">
              <img provider="cloudinary" src="/jpc2025.png" width="750" class="img-fluid rounded mx-auto d-block w-[45rem] h-auto" v-if="$screen.higherThan('md', $screen.current.value)" />
              <img provider="cloudinary" src="/jpc2025.png" width="750" class="img-fluid rounded mx-auto d-block w-[29.5rem]" v-else />
            </div>
